...
void init_viewgeometry(py::module& m)
{
    ...
    py::class_<SingleViewGeometry>(m, "SingleViewGeometry")
        ...
        {
            return SingleViewGeometry{{ pMats.cbegin(), pMats.cend() }};
        }), "p_mats"_a)
        ...
        {
            self.append({ pMats.cbegin(), pMats.cend() });
        }, "p_mat")
        ...
        .def("module", static_cast<mat::ProjectionMatrix&(SingleViewGeometry::*)
            (uint)>(&SingleViewGeometry::module), "i"_a)
    ...
    py::class_<FullGeometry>(m, "FullGeometry")
        ...
        {
            return FullGeometry{{ pMats.cbegin(), pMats.cend() }};
        }), "p_mats"_a)
